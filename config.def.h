...
/* tagging */
static const char *tags[] = { "Eli", "Dave", "Tim", "Charlie", "Pam", "Shelly" };
static const unsigned int gappx = 4; // Gap tiled, in pixels
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_Return, spawn,          SHCMD("mate-terminal") },
...
{ HYPERKEY,  XK_F12, spawn, SHCMD("/home/dach/bin/wincontrol HF1") },
{ HYPERKEY,  XK_F12, spawn, SHCMD("/home/dach/bin/wincontrol HF4") },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
